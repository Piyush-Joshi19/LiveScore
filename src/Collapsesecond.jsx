...
const MyCard = ({match}) => {
            ...
            <Card style ={{marginTop: 20}}>
                ...
                <CardActions>
                    <Grid container justify = "center">
                        <Grid item>
                            <Typography variant = "h5">{match.type}</Typography>
                        </Grid>
                    </Grid>
                </CardActions>
                <CardActions>
    ...
    const getDialog = () => (
        <Dialog open = {open} onClose = {handleClose}>
            ...
            <Typography>Match Started...</Typography>
            </DialogTitle>
            <DialogContent>
    ...
    <Typography>{match.toss_winner_team} {match.toss_winner_team? "Won the toss": ""} </Typography>
                        <Typography>
            ...
            <Typography>{match.winner_team} {match.winner_team? "Won the match": ""}</Typography>
                </DialogContentText>
            </DialogContent>
            <DialogActions>
